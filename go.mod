module github.com/vishruthsk/viper-go
...
require (
	...
	github.com/vishruthsk/utils-go v0.1.0
	github.com/vishruthsk/viper-network v0.1.1
...
replace github.com/tendermint/tm-db => github.com/vishruthsk/tm-db v0.1.0
