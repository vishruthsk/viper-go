...
import (
	...
	"github.com/vishruthsk/viper-network/app"
	"github.com/vishruthsk/viper-network/crypto"
	coreTypes "github.com/vishruthsk/viper-network/types"
	"github.com/vishruthsk/viper-network/x/auth"
	authTypes "github.com/vishruthsk/viper-network/x/auth/types"
)

const defaultTXFee = int64(10000)

// CoinDenom enum that represents all coin denominations of Viper
type CoinDenom string

const (
	// Uvip represents uvip denomination
	Uvip CoinDenom = "uvip"
	// Vip represents vip denomination
	Vip CoinDenom = "vip"
)
...
const (
	// Mainnet use for connecting to Viper Mainnet
	Mainnet ChainID = "mainnet"
	// Testnet use for connecting to Viper Testnet
	Testnet ChainID = "testnet"
	// Localnet use for connecting to Viper Localnet
